...
<div class="w3-bar w3-black w3-hide-small">
  ...
  <div class="w3-dropdown-hover w3-hide-small">
      ...
      <div class="w3-dropdown-content w3-bar-block w3-card-4">
        <a href="elektrotechnika_anyag1.php" class="w3-bar-item w3-button">Magyar</a>
      </div>
    </div>
...
<div class="w3-content" style="max-width:1600px">
    ...
    <div class="img-container">
        <div class="img-card">
            <img src="kep1.png" alt="Ohm's Law Diagram 1">
        </div>
        <div class="img-card">
            <img src="kep2.png" alt="Ohm's Law Diagram 2">
        </div>
        <div class="img-card">
            <img src="kep3.png" alt="Ohm's Law Diagram 3">
        </div>
    </div>
</div>
