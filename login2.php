...
// Include the database connection (using your provided config)
require_once "config.php"; // This connects to 'felhasznalok' database
...
<head>
    ...
    <style>
        /* Centering the login form using Flexbox */
        html, body {
            height: 100%;
            margin: 0;
            display: flex;
