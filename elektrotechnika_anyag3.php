...
<div class="w3-bar w3-black w3-hide-small">
  ...
  <div class="w3-dropdown-hover w3-hide-small">
      ...
      <div class="w3-dropdown-content w3-bar-block w3-card-4">
        <a href="eng_elektrotechnika3.php" class="w3-bar-item w3-button">English</a>
      </div>
    </div>
...
<div class="w3-content" style="max-width:1600px">
    <div class="subject-container">
        <div class="card">
            ...
            $sql = "SELECT cikkek FROM hun_cikkek WHERE id='3'";
    ...
    <div class="img-container">
         <div class="img-card">
            <img src="kep6.png" alt="Ohm's Law Diagram 2">
        </div>
        <div class="img-card">
            <img src="kep7.png" alt="Ohm's Law Diagram 1">
        </div>
        <div class="img-card">
            <img src="kep8.png" alt="Ohm's Law Diagram 2">
        </div>
        <div class="img-card">
            <img src="kep9.png" alt="Ohm's Law Diagram 1">
        </div>
        <div class="img-card">
            <img src="kep10.png" alt="Ohm's Law Diagram 2">
        </div>
    </div>
</div>
